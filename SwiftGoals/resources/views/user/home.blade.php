<x-main-layout>
  ...
  <section class="px-32 mt-10 mb-20">
    ...
    <section class="mt-10 mb-10 flex flex-wrap justify-between gap-10">
      ...
      <ul class="flex justify-between">
        <div>
          ...
          <li>
            ...
            <p class="w-96">I comprehend and resolve digital product issues using a user-focused methodology. Investigation, compassion, and visual conveyance are a few techniques I apply to captivate and involve your users while fulfilling your business requirements.</p>
          </li>
        </div>
        <div>
          <li class="mb-16">
            <h5 class="font-medium text-2xl mb-5">UI Design</h5>
            <p class="w-96">I create efficient, adaptable, and engaging websites. No predefined patterns. No sluggish, complex code. Webflow forms the foundation of my web development approach. I employ it to provide safe, top-notch bespoke websites.</p>
          </li>
          <li>
            <h5 class="font-medium text-2xl mb-5">Development</h5>
            <p class="w-96">I create user-friendly, adaptive, engaging websites. No cookie-cutters. No cumbersome, complex coding. Webflow forms the foundation of my web development approach. I employ it to produce safe, top-notch personalized websites.</p>
          </li>
        </div>
      </ul>
    </section>
