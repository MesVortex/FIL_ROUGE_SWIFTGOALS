<x-main-layout>
  ...
  <div class="w-auto h-screen ml-32 py-14">
    ...
    <section class="w-full flex flex-wrap justify-around gap-10">
      ...
      <div class="h-40 w-full max-w-md border-2 border-dashed flex items-center justify-center hover:bg-gray-100 transition-all duration-300 ease-in rounded-2xl relative">
