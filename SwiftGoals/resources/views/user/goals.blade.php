<nav class="bg-[#121e31] h-screen fixed top-0 left-0 min-w-[90px] py-6 font-[sans-serif]">
  <a href="javascript:void(0)" class="px-4"><img src="https://readymadeui.com/readymadeui-short-light.svg" alt="logo"
      class='w-[60px] mx-auto inline' />
  </a>
  <ul class="space-y-4 mt-10">
    <li class="relative group">
      <a href="javascript:void(0)" class="text-[#333] text-sm flex flex-col items-center bg-white px-4 py-4">
      ...
      <div
        class="absolute shadow-lg hidden group-hover:block bg-[#333] text-white font-semibold px-3 py-[6px] text-[13px] right-0 left-24 w-max top-3 rounded">
        Dashboard</div>
    </li>
    <li class="relative group">
      <a href="javascript:void(0)"
        class="text-white hover:text-[#333] text-sm flex justify-center items-center hover:bg-white px-4 py-4">
    ...
    <li class="relative group">
      <a href="javascript:void(0)"
        class="text-white hover:text-[#333] text-sm flex justify-center items-center hover:bg-white px-4 py-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke='currentColor' class="w-6 h-6"
