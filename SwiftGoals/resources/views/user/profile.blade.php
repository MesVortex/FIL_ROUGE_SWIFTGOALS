<x-main-layout>
    <section class="flex justify-center items-center bg-slate-500 py-10" style="">
        <div class="flex gap-5 justify-between items-start w-full max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
            ...
            <div class="flex flex-col self-end mt-6 w-7/12">
                ...
                <label for="username" class="mt-5 mb-3 text-sm font-semibold text-stone-800 max-md:max-w-full">Your
                    Email</label>
