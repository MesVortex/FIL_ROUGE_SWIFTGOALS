<x-main-layout>
  ...
  <div class="px-32">
    <div class="flex items-center mb-5 justify-between">
      <button class="flex items-center font-semibold text-3xl hover:text-blue-600 transition-all duration-300 ease-in group">
      ...
      <p class="font-semibold self-end">Filtering By : <span class="italic font-bold text-blue-600">All</span></p>
    </div>
    <div class="flex justify-between overflow-x-hidden group h-10 hover:h-auto">
      <ul class="flex justify-start font-bold gap-8 overflow-x-scroll transform -translate-x-full group-hover:translate-x-0 transition-all duration-300">
        <li class="">
          <a class="border-2 min-w-28 border-gray-300 text-gray-300 text py-5 px-7 rounded-3xl flex flex-col justify-center items-center hover:text-blue-600 hover:border-blue-600 transition-all duration-150 ease-in" href="">
            <svg class="text-gray-300 hover:text-blue-600 transition-all duration-150 ease-in" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
  ...
  <section class="my-10 px-10 flex flex-wrap justify-around gap-10">
