<x-authentication-layout>
  <section class="w-screen">
    <form id="form" class=" bg-transparent backdrop-filter backdrop-blur-sm bg-[#5882C1] bg-opacity-25 mt-10 pt-10 px-16 border-2 border-[#5882C1] border-opacity-15 rounded-3xl max-w-xl mx-auto" action="{{ route('user.register') }}" method="post">
      @csrf
      @method('POST')
      ...
      <div class="flex justify-between">
        <div class="mb-3">
          ...
          <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 px-3.5 " placeholder="Username">
          <p class=" hidden mt-2 text-sm font-bold text-red-700" id="NameInputHelp">Please enter a valid email! (exp: name@gmail.com)</p>
        </div>
        <div class="mb-3">
      ...
      <div class="mb-5">
        ...
        <input type="password" id="password_confirmation" name="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 px-3.5 " placeholder="Confirm Password">
        <p class=" hidden mt-2 text-sm font-bold text-red-700" id="PasswordInputHelp">Your password must be at least 8 characters!</p>
      </div>
