<!-- start navbar -->
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-indigo-500 p-6">

  <!-- logo -->
  <div class="flex-none w-56 flex flex-row items-center">
    <img src="{{ asset('/images/SwiftGoalsMainLogo-removebg-preview.png') }}" class="w-10 flex-none">
    <strong class="capitalize ml-1 flex-1 text-white">SwiftGoals</strong>

    <button id="toggle-sidebar" class="block md:hidden absolute top-0 left-0 mt-4 ml-4 p-2 rounded-lg bg-gray-200 text-gray-700">
