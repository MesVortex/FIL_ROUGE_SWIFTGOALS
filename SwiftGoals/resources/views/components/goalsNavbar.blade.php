@props(['page'])
<nav class="bg-transparent border-gray-200 dark:bg-gray-900 fixed top-0 left-0">
  <div class="flex flex-wrap items-center justify-between px-4 mx-auto">
    ...
    <div class="items-center justify-between hidden w-full lg:flex lg:justify-center lg:w-full lg:order-1" id="mobile-menu-2">
      <ul class="flex flex-col mt-4 font-medium lg:items-center lg:justify-around lg:space-y-8 lg:min-h-screen lg:px-3 lg:mt-0 lg:bg-[#012E4A] p-1 rounded-full">
        <li class="lg:bg-white lg:px-2 lg:py-1.5 lg:rounded-full">
        ...
        <li @if ( $page == 'pinned goals' ) class="lg:bg-white lg:text-black lg:px-2.5 lg:py-1.5 lg:rounded-full relative group" @else class="lg:hover:bg-white lg:hover:px-2.5 lg:text-[#C4C4C4] lg:hover:py-1.5 lg:hover:rounded-full transition-all relative group" @endif>
        ...
        <li class="lg:hover:bg-white lg:hover:px-2.5 lg:text-[#C4C4C4] lg:hover:py-1.5 lg:hover:rounded-full transition-all relative group">
        ...
        <li class="lg:hover:bg-white lg:hover:px-2.5 lg:text-[#C4C4C4] lg:hover:py-1.5 lg:hover:rounded-full transition-all relative group">
          <a href="{{ route('community') }}" class="block py-2 pl-3 pr-4 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-black lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="h-6 w-6 lg:fill-[#C4C4C4] lg:hover:fill-black">
        ...
        <li class="lg:bg-white lg:px-2 lg:py-1.5 lg:rounded-full">
          <a href="{{ route('profile') }}" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:text-[#C4C4C4] lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">
            <img class="rounded-full h-7" src="{{ asset('images/default_profile.png') }}" alt="">
          </a>
        </li>
      </ul>
    </div>
